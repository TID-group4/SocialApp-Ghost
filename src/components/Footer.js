...
import ghostLogo from '../material/ghost_logo.png'; // Import the ghost logo image
  ...
  return (
    <footer style={styles.footer}>
      <div style={styles.footerContent}>
        ...
        <img src={ghostLogo} alt="Ghost Logo" style={styles.profileImage} />
        ...
        <div style={styles.footerTextContainer}>
          ...
          <p style={styles.footerCopyright}>Copyright © GHOST 2024</p> {/* Copyright text */}
        </div>
      </div>
    </footer>
  );
...
const styles = {
  ...
  profileImage: {
    width: '114px', // Width for the ghost icon
    height: '121px', // Height for the ghost icon
